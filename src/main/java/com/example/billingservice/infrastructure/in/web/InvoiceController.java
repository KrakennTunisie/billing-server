...
public class InvoiceController {
    ...
    @PostMapping(path = CLIENT_INVOICES, consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    public ResponseEntity <Page<InvoicePageItemDTO>> getSuppliersInvoices(@RequestParam(required = false) String keyword,
                                                                        ...
                                                                        @RequestParam int page )
    {
        return ResponseEntity.ok(invoiceUseCase.getSuppliersInvoices(keyword, status, page));
    }
